        ...
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="password" type={showPassword ? "text" : "password"} placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} className="h-12 bg-[#111827] border-[#1F2937]" />
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-[#1F2937]">
            <Button variant="outline" className="w-full h-12 border-[#1F2937] text-gray-400 hover:text-white" onClick={handleGoogleLogin}>Sign in with Google</Button>
          </div>
        </div>
      </div>
    </div>
